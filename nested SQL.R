...
#filtering the data
View(sqldf("select region,Quantity,Discount from d1 where region=='Central' limit 20"))#Sorting
View(sqldf("select * from d1 order by City desc limit 20"))
View(sqldf("select * from d1 order by City desc"))
...
sqldf("select region from d1 where  Profit== (Select min(Profit) from d1)")

sqldf("select city from d1 where  Profit== (Select max(Profit) from d1)")
sqldf("select city from d1 where  Profit== (Select min(Profit) from d1)")
