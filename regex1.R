...
#Typically, regex patterns consist of a combination 
#of alphanumeric characters as well as special characters.

#The following provides examples to show how to use the escape 
#syntax to find and replace metacharacters. 
