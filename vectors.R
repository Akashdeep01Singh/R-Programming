...
# Atomic vector of type raw.
print(charToRaw('abcdefghijklmnopqrstuvwxy z'))
print(charToRaw('ABCDEFGHIJKLMNOPQRSTUVWXY Z'))
print(charToRaw('!@#$%^&*()_+'))
print(charToRaw('1234567890'))
...
rm(list=ls())
#if you want to delete all the variable including hidden variable
rm(list=ls(all.names=TRUE))

#vectors
d<-50:100
d[-5][-30]#firstly it will remove the value at index 5 and then change the indexing after changing remove the updated value at index 30
d[c(-5,-30)]#at the same time will remove the value at index 5 and 30, gives desired result