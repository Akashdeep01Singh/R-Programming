...
#The apply() function,The lapply() function
#The sapply() function ,The tapply() function,The mapply() function
#Apply()
...
#************************************************************
#lapply() function:It takes list as an argument and
...
#****************************************************************
#sapply() function:It is the same as lapply()with the only difference being the type of return object.
#if the result is a list with each element of length unity then vector will be returned
