...
typeof(top.cities)
class(top.cities)
#save(top.cities,file="~/top.cities.RData")

#save(top.cities,file="D:/R Programs/top.cities.rda")
#load("~/top.cities")
...
data_1=data.frame(
  name=c("aashima","aashi"),
  age=c(20,25))
data_1
data_2<-data.frame(name=c("smeera","reeve"),
       age=c(26,27))
data_2
...
data_frame1<-data.frame(name=c("aaashima","ankja"),subject=c("R","Java"),marks=c(100,200))
data_frame1
length(data_frame1)
#***********************
