...
class(x)
#*--------*******
## creates a matrix of 3 rows and 5 columns and all the fields in the 
#matrix are set to 1.
matrix(1,3,5) 
#*********
PQ=1:15 
matrix(PQ,3,5)
#*------------*----------
#matrix(5,5,5)  # calling a matrix() function creates a matrix of 
#5 rows and 5 columns and all the fields in the matrix are set to 5. 
#This is known as square matrix.
matrix(5,5,5)
#********------------------**********************
...
cat("multiplication of two matrix is:","\n")
result2
#divide matrix
